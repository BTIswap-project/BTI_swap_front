...
export default function Home() {
  ...
  return (
    <DefaultAnimation>
    <div className="container mx-auto flex flex-col main-container items-center justify-center w-full px-[25px] py-[45px]">
      <div className="flex  flex-wrap flex-col border w-full border-green-default px-[25px] max-w-[500px] py-[33px] rounded-[12px] bg-white dark:bg-gray-dark space-y-3">
          ...
          <div className="flex flex-col p-[10px] bg-light-default dark:bg-black rounded-[10px] space-y-1 relative">
            ...
            <div className="flex justify-between">
              <p className="text-[12px] font-normal leading-[17px] text-gray-light">
                {t('balance')}: 2.8989 BNB <span className="text-black dark:text-white">{t('max')}</span>
              </p>
              <p className="text-[12px] font-normal leading-[17px] text-gray-light">
                ≈$ 1726.2307
              </p>
            </div>
            <div className='flex w-[30px] md:w-[56px] h-[30px] md:h-[56px]  bg-light-light dark:bg-gray-dark rounded-full items-center justify-center border-2 border-green-default  absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-5 md:translate-y-7'>
              <FontAwesomeIcon 
                  icon={faArrowRightArrowLeft} 
                  className="text-[15px] md:text-[25px] text-white dark:text-gray-light rotate-90" 
              />
            </div>
          </div>
        ...
        <p className="text-[12px] font-normal leading-[17px] text-gray-light">
          {t('maxslippage')}: <span className="text-black dark:text-white">0.05%</span>
        </p>
